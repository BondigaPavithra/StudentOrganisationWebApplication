		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-8">
					...
					<form class="form-group" name="myform" method="post" action="student_register">
						...
						<div class="form-group">
							...
							<input type="text" onfocus="dispuser()" onblur="verifyuser()" class="form-control" id="username" name="username" placeholder="*Username" required>
							<p id="user"></p>
						</div>
						<div class="form-group">
							<label for="password">Password:</label>
							<input type="password" onfocus="disppwd()" onblur="verifypwd()" class="form-control" id="password" name="password" placeholder="*Password" required>
							<p id="pwd"></p>
						</div>
						<div class="form-group">
							<label for="re-enterpwd">Confirm Password:</label>
							<input type="password" onfocus="disprepwd()" onblur="verifypwd()" class="form-control" id="re-enterpwd" name="re-enterpwd" placeholder="*Confirm Password" required>
							<p id="repwd"></p>
						</div>
						<div class="form-group">
							<label for="mobile_no">Mobile Number:</label>
							<input type="text" onfocus="dispmobile()" onblur="verifymobile(event)" class="form-control" id="mobile" name="mobile" placeholder="*Mobile Number" required>
							<p id="mobileMsg"></p>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="year_of_exp">Year of Passed:</label>
